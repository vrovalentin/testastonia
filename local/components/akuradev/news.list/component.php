...
$arFilterParams = [];
$arFilterParams["ORDER"] = ['SORT' => 'ASC'];
$arFilterParams["SELECT"] = ['ID', 'NAME', 'IBLOCK_ID','PREVIEW_TEXT'];
$arFilterParams["FILTER"] = ['IBLOCK_ID' => 5];
$arFilterParams["LIMIT"] = 50;

$arElementList = $this->getIblockList($arFilterParams);
